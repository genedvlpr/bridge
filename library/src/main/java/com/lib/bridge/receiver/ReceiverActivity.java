...
import static com.lib.bridge.receiver.ReceiverActivity.WifiTasksHandler.SCAN_FOR_WIFI_RESULTS;
import static com.lib.bridge.receiver.ReceiverActivity.WifiTasksHandler.WAIT_FOR_CONNECT_ACTION_TIMEOUT;
import static com.lib.bridge.receiver.ReceiverActivity.WifiTasksHandler.WAIT_FOR_RECONNECT_ACTION_TIMEOUT;
import static com.lib.bridge.utils.Utils.isOreoOrAbove;
import static com.lib.bridge.utils.WifiUtils.connectToOpenWifi;
...
public class ReceiverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_receiver_control.setVisibility(View.INVISIBLE);
        btn_scan = findViewById(R.id.scan);

        btn_scan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ReceiverActivity.this, ScanActivity.class);
                startActivity(i);
...
//                        }
    ...
    private String[] setConnectedUi(String ssid) {
        ...
        m_p2p_connection_status.setText(getString(R.string.p2p_receiver_connected_hint, ssid));
