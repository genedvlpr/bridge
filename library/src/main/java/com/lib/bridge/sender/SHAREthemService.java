...
import static com.lib.bridge.sender.SHAREthemService.ShareIntents.SHARE_CLIENT_IP;
import static com.lib.bridge.sender.SHAREthemService.ShareIntents.SHARE_SERVER_UPDATES_INTENT_ACTION;
import static com.lib.bridge.sender.SHAREthemService.ShareIntents.SHARE_SERVER_UPDATE_FILE_NAME;
import static com.lib.bridge.sender.SHAREthemService.ShareIntents.SHARE_SERVER_UPDATE_TEXT;
import static com.lib.bridge.sender.SHAREthemService.ShareIntents.SHARE_TRANSFER_PROGRESS;
import static com.lib.bridge.sender.SHAREthemService.ShareIntents.TYPE;
import static com.lib.bridge.sender.SHAREthemService.ShareIntents.Types.AP_DISABLED_ACKNOWLEDGEMENT;
import static com.lib.bridge.sender.SHAREthemService.ShareIntents.Types.FILE_TRANSFER_STATUS;
...
public class SHAREthemService extends Service {
    ...
    public void onCreate() {
        ...
        try{
            ...
            Toast.makeText(getApplicationContext(),"Notification permission is not enabled.", Toast.LENGTH_SHORT).show();
        }
