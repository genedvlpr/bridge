...
public class HotspotControl {
     ...
     * @param port Port number assigned to {@link com.lib.bridge.sender.SHAREthemServer}, not used anywhere in {@link HotspotControl} but helps {@link SHAREthemActivity} to display port info
